  ...
  return (
    <div className="mx-10 py-[30px]">
      ...
      <div className="flex flex-col items-center lg:flex-row lg:flex-wrap gap-3">
          {topSelling.map((item)=>(
            <div key={item.id} className="w-[280px] block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
            <TERipple>
